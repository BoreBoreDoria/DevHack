...
RouterStore.ɵprov = ɵɵdefineInjectable({ factory: function RouterStore_Factory() { return new RouterStore(); }, token: RouterStore, providedIn: "root" });
...
RouterQuery.ɵprov = ɵɵdefineInjectable({ factory: function RouterQuery_Factory() { return new RouterQuery(ɵɵinject(RouterStore)); }, token: RouterQuery, providedIn: "root" });
RouterQuery.ctorParameters = () => [
    { type: RouterStore }
];
...
RouterService.ɵprov = ɵɵdefineInjectable({ factory: function RouterService_Factory() { return new RouterService(ɵɵinject(RouterStore), ɵɵinject(RouterQuery), ɵɵinject(Router)); }, token: RouterService, providedIn: "root" });
RouterService.ctorParameters = () => [
    { type: RouterStore },
    { type: RouterQuery },
    { type: Router }
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RouterStore, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return []; }, null); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RouterQuery, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
AkitaNgRouterStoreModule.ɵfac = function AkitaNgRouterStoreModule_Factory(t) { return new (t || AkitaNgRouterStoreModule)(ɵngcc0.ɵɵinject(RouterService)); };
AkitaNgRouterStoreModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AkitaNgRouterStoreModule });
AkitaNgRouterStoreModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
AkitaNgRouterStoreModule.ctorParameters = () => [
    { type: RouterService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AkitaNgRouterStoreModule, [{
        type: NgModule
