    ...
    ***************************************************************************** */
    ...
    var DateRangePopupComponent = /** @class */ (function () {
        ...
        DateRangePopupComponent.prototype.init = function () {
            ...
            this.datePickerService.setValue(time.cloneDate(this.datePickerService.value));
        };
        /**
    ...
    var NzPickerComponent = /** @class */ (function () {
        ...
        NzPickerComponent.prototype.onFocusout = function (event) {
            event.preventDefault();
            this.focusChange.emit(false);
            var isFocus = this.elementRef.nativeElement.contains(event.relatedTarget);
            if (!isFocus) {
                this.checkAndClose();
            }
        };
        ...
        NzPickerComponent.prototype.checkAndClose = function () {
            if (!this.realOpenState) {
                return;
            }
