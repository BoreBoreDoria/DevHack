...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var l=function(e,t){return(l=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])})(e,t)};function d(e,t){function n(){this.constructor=e}l(e,t),e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}Object.create;function f(e,t){var n="function"==typeof Symbol&&e[Symbol.iterator];if(!n)return e;var o,r,i=n.call(e),s=[];try{for(;(void 0===t||t-- >0)&&!(o=i.next()).done;)s.push(o.value)}catch(e){r={error:e}}finally{try{o&&!o.done&&(n=i.return)&&n.call(i)}finally{if(r)throw r.error}}return s}function y(){for(var e=[],t=0;t<arguments.length;t++)e=e.concat(f(arguments[t]));return e}Object.create;var m=0,v=function(){function e(e,t,n){this.nzSingletonService=e,this.overlay=t,this.injector=n}return e.prototype.remove=function(e){this.container&&(e?this.container.remove(e):this.container.removeAll())},e.prototype.getInstanceId=function(){return this.componentPrefix+"-"+m++},e.prototype.withContainer=function(e){var n=this.nzSingletonService.getSingletonWithKey(this.componentPrefix);if(n)return n;var o=this.overlay.create({hasBackdrop:!1,scrollStrategy:this.overlay.scrollStrategies.noop(),positionStrategy:this.overlay.position().global()}),r=new t.ComponentPortal(e,null,this.injector),i=o.attach(r);return o.overlayElement.style.zIndex="1010",n||(this.container=n=i.instance,this.nzSingletonService.registerSingletonWithKey(this.componentPrefix,n)),n},e}(),z=function(){function e(e,t){this.cdr=e,this.nzConfigService=t,this.instances=[],this.destroy$=new r.Subject,this.updateConfig()}return e.prototype.ngOnInit=function(){this.subscribeConfigChange()},e.prototype.ngOnDestroy=function(){this.destroy$.next(),this.destroy$.complete()},e.prototype.create=function(e){var t=this.onCreate(e);return this.instances.length>=this.config.nzMaxStack&&(this.instances=this.instances.slice(1)),this.instances=y(this.instances,[t]),this.readyInstances(),t},e.prototype.remove=function(e,t){var n=this;void 0===t&&(t=!1),this.instances.some((function(o,r){return o.messageId===e&&(n.instances.splice(r,1),n.instances=y(n.instances),n.onRemove(o,t),n.readyInstances(),!0)}))},e.prototype.removeAll=function(){var e=this;this.instances.forEach((function(t){return e.onRemove(t,!1)})),this.instances=[],this.readyInstances()},e.prototype.onCreate=function(e){return e.options=this.mergeOptions(e.options),e.onClose=new r.Subject,e},e.prototype.onRemove=function(e,t){e.onClose.next(t),e.onClose.complete()},e.prototype.readyInstances=function(){this.cdr.detectChanges()},e.prototype.mergeOptions=function(e){var t=this.config,n=t.nzDuration,o=t.nzAnimate,r=t.nzPauseOnHover;return Object.assign({nzDuration:n,nzAnimate:o,nzPauseOnHover:r},e)},e}();z.decorators=[{type:n.Directive}],z.ctorParameters=function(){return[{type:n.ChangeDetectorRef},{type:o.NzConfigService}]};var C=function(){function e(e){this.cdr=e,this.destroyed=new n.EventEmitter,this.eraseTimer=null}return e.prototype.ngOnInit=function(){this.options=this.instance.options,this.options.nzAnimate&&(this.instance.state="enter"),this.autoClose=this.options.nzDuration>0,this.autoClose&&(this.initErase(),this.startEraseTimeout())},e.prototype.ngOnDestroy=function(){this.autoClose&&this.clearEraseTimeout()},e.prototype.onEnter=function(){this.autoClose&&this.options.nzPauseOnHover&&(this.clearEraseTimeout(),this.updateTTL())},e.prototype.onLeave=function(){this.autoClose&&this.options.nzPauseOnHover&&this.startEraseTimeout()},e.prototype.destroy=function(e){var t=this;void 0===e&&(e=!1),this.options.nzAnimate?(this.instance.state="leave",this.cdr.detectChanges(),setTimeout((function(){t.destroyed.next({id:t.instance.messageId,userAction:e})}),200)):this.destroyed.next({id:this.instance.messageId,userAction:e})},e.prototype.initErase=function(){this.eraseTTL=this.options.nzDuration,this.eraseTimingStart=Date.now()},e.prototype.updateTTL=function(){this.autoClose&&(this.eraseTTL-=Date.now()-this.eraseTimingStart)},e.prototype.startEraseTimeout=function(){var e=this;this.eraseTTL>0?(this.clearEraseTimeout(),this.eraseTimer=setTimeout((function(){return e.destroy()}),this.eraseTTL),this.eraseTimingStart=Date.now()):this.destroy()},e.prototype.clearEraseTimeout=function(){null!==this.eraseTimer&&(clearTimeout(this.eraseTimer),this.eraseTimer=null)},e}();C.decorators=[{type:n.Directive}],C.ctorParameters=function(){return[{type:n.ChangeDetectorRef}]};var S="message",T={nzAnimate:!0,nzDuration:3e3,nzMaxStack:7,nzPauseOnHover:!0,nzTop:24},O=function(e){function t(t,n){var o=e.call(this,t,n)||this;return o.destroy$=new r.Subject,o.instances=[],o}return d(t,e),t.prototype.subscribeConfigChange=function(){var e=this;this.nzConfigService.getConfigChangeEventForComponent(S).pipe(c.takeUntil(this.destroy$)).subscribe((function(){return e.updateConfig()}))},t.prototype.updateConfig=function(){this.config=Object.assign(Object.assign(Object.assign({},T),this.config),this.nzConfigService.getConfigForComponent(S)),this.top=a.toCssPixel(this.config.nzTop),this.cdr.markForCheck()},t}(z);O.decorators=[{type:n.Component,args:[{changeDetection:n.ChangeDetectionStrategy.OnPush,encapsulation:n.ViewEncapsulation.None,selector:"nz-message-container",exportAs:"nzMessageContainer",preserveWhitespaces:!1,template:'\n    <div class="ant-message" [style.top]="top">\n      <nz-message *ngFor="let instance of instances" [instance]="instance" (destroyed)="remove($event.id, $event.userAction)"></nz-message>\n    </div>\n  '}]}],O.ctorParameters=function(){return[{type:n.ChangeDetectorRef},{type:o.NzConfigService}]};var j=function(){};j.decorators=[{type:n.NgModule}];var I=function(e){function t(t,n,o){var r=e.call(this,t,n,o)||this;return r.componentPrefix="message-",r}return d(t,e),t.prototype.success=function(e,t){return this.createInstance({type:"success",content:e},t)},t.prototype.error=function(e,t){return this.createInstance({type:"error",content:e},t)},t.prototype.info=function(e,t){return this.createInstance({type:"info",content:e},t)},t.prototype.warning=function(e,t){return this.createInstance({type:"warning",content:e},t)},t.prototype.loading=function(e,t){return this.createInstance({type:"loading",content:e},t)},t.prototype.create=function(e,t,n){return this.createInstance({type:e,content:t},n)},t.prototype.createInstance=function(e,t){return this.container=this.withContainer(O),this.container.create(Object.assign(Object.assign({},e),{createdAt:new Date,messageId:this.getInstanceId(),options:t}))},t}(v);I.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new I(n.ɵɵinject(s.NzSingletonService),n.ɵɵinject(i.Overlay),n.ɵɵinject(n.INJECTOR))},token:I,providedIn:j}),I.decorators=[{type:n.Injectable,args:[{providedIn:j}]}],I.ctorParameters=function(){return[{type:s.NzSingletonService},{type:i.Overlay},{type:n.Injector}]};var b=function(e){function t(t){var o=e.call(this,t)||this;return o.destroyed=new n.EventEmitter,o}return d(t,e),t}(C);b.decorators=[{type:n.Component,args:[{changeDetection:n.ChangeDetectionStrategy.OnPush,encapsulation:n.ViewEncapsulation.None,selector:"nz-message",exportAs:"nzMessage",preserveWhitespaces:!1,animations:[h.moveUpMotion],template:'\n    <div class="ant-message-notice" [@moveUpMotion]="instance.state" (mouseenter)="onEnter()" (mouseleave)="onLeave()">\n      <div class="ant-message-notice-content">\n        <div class="ant-message-custom-content" [ngClass]="\'ant-message-\' + instance.type">\n          <ng-container [ngSwitch]="instance.type">\n            <i *ngSwitchCase="\'success\'" nz-icon nzType="check-circle"></i>\n            <i *ngSwitchCase="\'info\'" nz-icon nzType="info-circle"></i>\n            <i *ngSwitchCase="\'warning\'" nz-icon nzType="exclamation-circle"></i>\n            <i *ngSwitchCase="\'error\'" nz-icon nzType="close-circle"></i>\n            <i *ngSwitchCase="\'loading\'" nz-icon nzType="loading"></i>\n          </ng-container>\n          <ng-container *nzStringTemplateOutlet="instance.content">\n            <span [innerHTML]="instance.content"></span>\n          </ng-container>\n        </div>\n      </div>\n    </div>\n  '}]}],b.ctorParameters=function(){return[{type:n.ChangeDetectorRef}]},b.propDecorators={instance:[{type:n.Input}],destroyed:[{type:n.Output}]};var w=function(){};w.decorators=[{type:n.NgModule,args:[{imports:[u.CommonModule,i.OverlayModule,g.NzIconModule,p.NzOutletModule,j],declarations:[O,b],entryComponents:[O]}]}],e.NzMNComponent=C,e.NzMNContainerComponent=z,e.NzMNService=v,e.NzMessageComponent=b,e.NzMessageContainerComponent=O,e.NzMessageModule=w,e.NzMessageService=I,e.NzMessageServiceModule=j,Object.defineProperty(e,"__esModule",{value:!0})}));
