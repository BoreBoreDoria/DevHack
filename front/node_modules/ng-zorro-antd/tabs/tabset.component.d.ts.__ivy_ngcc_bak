...
export declare class NzTabSetComponent implements OnInit, AfterContentChecked, OnDestroy, AfterContentInit, OnChanges {
    ...
    constructor(nzConfigService: NzConfigService, cdr: ChangeDetectorRef, router: Router);
    ngOnInit(): void;
    ngOnDestroy(): void;
